...
knots_offset = lim_lo
	if c_reading[posn_no] >= lim_lo and c_reading[posn_no] < lim_hi then
		...
		img_rotate(ltl_hand, 127+deg_offs+(360*(c_reading[posn_no]/c_travel)*10))
...
fsx_variable_subscribe("TURB ENG CORRECTED N1:2", "Percent", N1_posn_FSX)
